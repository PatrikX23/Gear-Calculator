...
# kompenzált
    ...
    if int(kerekitesInput) >= 2 and int(kerekitesInput) <= 6:
        ...
        if datasdone:
            ...
            print("d2: "+ str(float(str(kerekites).format(d2)))+"mm")
            print("\nda1: "+ str(float(str(kerekites).format(da1)))+"mm")
            print("da2: "+ str(float(str(kerekites).format(da2)))+"mm")
            print("\ndb1: "+ str(float(str(kerekites).format(db1)))+"mm")
            print("db2: "+ str(float(str(kerekites).format(db2)))+"mm")
            print("\ndf1: "+ str(float(str(kerekites).format(df1)))+"mm")
            print("df2: "+ str(float(str(kerekites).format(df2)))+"mm")
            print("\nh1: "+ str(float(str(kerekites).format(h1)))+"mm")
            print("h2: "+ str(float(str(kerekites).format(h2)))+"mm")
            print("\nha1: "+ str(float(str(kerekites).format(ha1)))+"mm")
            print("ha2: "+ str(float(str(kerekites).format(ha2)))+"mm")
            print("\nhf1: "+ str(float(str(kerekites).format(hf1)))+"mm")
            print("hf2: "+ str(float(str(kerekites).format(hf2)))+"mm")
            print("\nhw: "+ str(float(str(kerekites).format(hw)))+"mm")
            print("aw: "+ str(float(str(kerekites).format(aw)))+"mm")
            print("\nP: "+ str(float(str(kerekites).format(p)))+"mm")
            print("s1: "+ str(float(str(kerekites).format(s1)))+"mm")
            print("s2: "+ str(float(str(kerekites).format(s2)))+"mm")